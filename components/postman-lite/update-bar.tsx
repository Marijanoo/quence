    ...
    <>
      ...
      <div className="flex items-center gap-2 flex-1 mx-4">
        <div className="relative flex-1 h-1 rounded-full bg-primary/20 overflow-hidden">
          ...
          >
            {/* sweeping glass/white highlight inside the fill */}
            {!downloaded && (
              <div
        ...
        {downloaded ? (
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={onDismiss}
              className="text-xs text-primary/60 hover:text-primary transition-colors whitespace-nowrap"
            >
              Later
            </button>
          </div>
          ...
          <span className="text-xs text-primary whitespace-nowrap">
            Updating… {Math.round(progress ?? 0)}%
          </span>
        )}
      </div>
    </>
